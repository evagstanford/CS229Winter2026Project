...
print("optimal params for bill_hist:", cv_search_random.best_params_)
...
top100.to_csv("HGBoost/100_test_bill.csv", index=False)
print("See HGBoost/100_test_bill.csv for top 100")
...
with open("HGBoost/HGBoost_bill_results100.txt", "w") as f:
