# This file produces the top 100 buildings for predicted burden reduction using Ridge
import pandas as pd
import numpy as np
...
top100.to_csv("L2/100_test_burden.csv", index=False)
print("See L2/100_test_burden.csv for top 100")
...
with open("L2/L2_burden_results100.txt", "w") as f:
