# This file produces the top 200 buildings for predicted burden reduction using a Histogram Gradient Boosting Regressor
import pandas as pd
import numpy as np
...
top200.to_csv("HGBoost/200_test_burden.csv", index=False)
print("See HGBoost/200_test_burden.csv for top 200")
...
with open("HGBoost/HGBoost_burden_results.txt", "w") as f:
