# This file produces the top 100 buildings for predicted bill savings using a Histogram Gradient Boosting Regressor
import pandas as pd
import numpy as np
...
print("optimal params for emis_hist:", cv_search_random.best_params_)


preds = use_pipeline.predict(input_test)
r2 = r2_score(output_test, preds)
print("R^2 score for emis:", r2)
...
top100.to_csv("HGBoost/100_test_emis.csv", index=False)
print("See HGBoost/100_test_emis.csv for top 100")
...
with open("HGBoost/HGBoost_emis_results100.txt", "w") as f:
    f.write(f"Hist. Grad. Boosting Reg. for Emission Red.\n")
