# This file produces the top 100 buildings for predicted electricity energy savings using OLS
import pandas as pd
import numpy as np
...
top100.to_csv("OLS/100_test_elec.csv", index=False)
print("See OLS/100_test_elec.csv for top 100")
...
with open("OLS/OLS_elec_results100.txt", "w") as f:
