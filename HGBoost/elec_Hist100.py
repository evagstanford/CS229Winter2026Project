# This file produces the top 100 buildings for predicted electricity energy savings using a Histogram Gradient Boosting Regressor
import pandas as pd
import numpy as np
...
top100.to_csv("HGBoost/100_test_elec.csv", index=False)
print("See HGBoost/100_test_elec.csv for top 100")
...
with open("HGBoost/HGBoost_elec_results100.txt", "w") as f:
