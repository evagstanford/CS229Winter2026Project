# This file produces the top 100 buildings for predicted burden reduction using OLS
import pandas as pd
import numpy as np
...
top100.to_csv("OLS/100_test_burden.csv", index=False)
print("See OLS/100_test_burden.csv for top 100")
...
with open("OLS/OLS_burden_results100.txt", "w") as f:
    f.write(f"OLS for Burden Reduction\n")
