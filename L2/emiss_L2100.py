# This file produces the top 100 buildings for predicted bill savings using Ridge
import pandas as pd
import numpy as np
...
top100.to_csv("L2/100_test_emis.csv", index=False)
print("See L2/100_test_emis.csv for top 100")
...
with open("L2/L2_emis_results100.txt", "w") as f:
