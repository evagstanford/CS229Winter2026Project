# This file produces the top 200 buildings for predicted bill savings using a Histogram Gradient Boosting Regressor
import pandas as pd
import numpy as np
...
top200.to_csv("HGBoost/200_test_emis.csv", index=False)
print("See HGBoost/200_test_emis.csv for top 200")
...
with open("HGBoost/HGBoost_emis_results.txt", "w") as f:
