# This file produces the top 200 buildings for predicted electricity energy savings using Ridge
import pandas as pd
import numpy as np
...
top200.to_csv("L2/200_test_elec.csv", index=False)
print("See L2/200_test_elec.csv for top 200")
...
with open("L2/L2_elec_results.txt", "w") as f:
