...
top200.to_csv("RF/200_test_emis.csv", index=False)
print("See RF/200_test_emis.csv for top 200")
...
with open("RF/RF_emis_results.txt", "w") as f:
    f.write(f"R2 for Emission Reduction\n")
