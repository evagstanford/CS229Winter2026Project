# This file produces the top 200 buildings for predicted burden reduction using OLS
import pandas as pd
import numpy as np
...
top200.to_csv("OLS/200_test_burden.csv", index=False)
print("See OLS/200_test_burden.csv for top 200")
...
with open("OLS/OLS_burden_results.txt", "w") as f:
