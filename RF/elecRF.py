...
top200.to_csv("RF/200_test_elec.csv", index=False)
print("See RF/200_test_elec.csv for top 200")
...
with open("RF/RF_elec_results.txt", "w") as f:
    f.write(f"R2 for Electricity Savings\n")
