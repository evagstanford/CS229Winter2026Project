...
top200.to_csv("RF/200_test_burden.csv", index=False)
print("See RF/200_test_burden.csv for top 200")
...
with open("RF/RF_burden_results.txt", "w") as f:
    f.write(f"RF for Burden Reduction\n")
